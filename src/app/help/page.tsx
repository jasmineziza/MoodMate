...
export default function StatsPage() {
  ...
  const EmotionSummary = ({ entries, title }: { entries: EmotionEntry[]; title: string; selectedDate?: Date }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-10">
      ...
      {/* Title */}
      <h1 className="text-center text-blue-600 font-semibold text-2xl mb-8 pt-6">
